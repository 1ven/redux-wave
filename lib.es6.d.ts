...
declare namespace Intl {
  ...
  var NumberFormat: {
    new (locales?:
      | string
      | string[], options?: NumberFormatOptions): NumberFormat;
  ...
  var DateTimeFormat: {
    new (locales?:
      | string
      | string[], options?: DateTimeFormatOptions): DateTimeFormat;
    (locales?:
      | string
      | string[], options?: DateTimeFormatOptions): DateTimeFormat;
    supportedLocalesOf(
...
declare var File: {
  ...
  new (parts: (
    ...
    | ArrayBufferView
    | Blob
    | string)[], filename: string, properties?: FilePropertyBag): File;
};
...
declare var RTCRtpReceiver: {
  ...
  new (transport:
    | RTCDtlsTransport
    | RTCSrtpSdesTransport, kind: string, rtcpTransport?: RTCDtlsTransport): RTCRtpReceiver;
...
declare var RTCRtpSender: {
  ...
  new (track: MediaStreamTrack, transport:
    | RTCDtlsTransport
